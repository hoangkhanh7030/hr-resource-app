...
public interface ProjectService {
    ...
    MessageResponse updateProject(ProjectRequest projectRequest, Integer idAccount,
                                  Integer idProject,Integer idWorkspace);
    MessageResponse deleteProject(Integer idProject,Integer idWorkspace);
    List<ProjectDTO> searchParameter(String name, Boolean isActivate, Integer idWorkspace,
                                     int page, int size);
    ...
    List<ProjectDTO> sortAndSearchListProject(Integer idWorkspace, int page, int size,
                                              String nameSearch, String sortColumn, String type);
    List<ProjectDTO> sortAndSearchProjectListWithStatusFilter(Integer idWorkspace,
                                                              int page, int size, Boolean isActivate,
                                                              String nameSearch, String sortColumn, String type);
    List<ProjectDTO> searchParameterWithoutStatus(String name, Integer idWorkspace,
                                                  int page, int size);
