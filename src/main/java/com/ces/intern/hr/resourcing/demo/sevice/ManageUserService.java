...
public interface ManageUserService {
    ...
    void reSendEmail(ReInviteRequest reInviteRequest,
                     Integer idWorkspace) throws MessagingException, IOException, Exception;
    void isActive(Integer idAccount, Integer idWorkspace,
                  String url) throws MessagingException, IOException,Exception;
